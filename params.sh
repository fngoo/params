...
echo "for c in "\`cat /root/script/3_httprobe/dir_$i/${input}\`"; do echo \" \" >> /root/script/3_httprobe/dir_${i}/xss.txt ; echo \" \" >> /root/script/3_httprobe/dir_${i}/xss.txt ; echo \" \" >> /root/script/3_httprobe/dir_${i}/xss.txt ; echo \"\$c\" >> /root/script/3_httprobe/dir_${i}/xss.txt ; echo '------- ------------ ------------ -------------' >> /root/script/3_httprobe/dir_${i}/xss.txt ; python3 xsstrike.py -u \"\$c\" --skip --blind >> /root/script/3_httprobe/dir_${i}/xss.txt ; line=\`cat /root/script/3_httprobe/dir_${i}/xss.txt | wc -l\` ; if [ \$line -lt 25 ]; then > /root/script/3_httprobe/dir_${i}/xss.txt ; fi; cat /root/script/3_httprobe/dir_${i}/xss.txt >> \${output}/xsstrike.txt ; rm /root/script/3_httprobe/dir_${i}/xss.txt; done" >> /root/script/3_httprobe/dir_$i/${i}.sh
